...
export default function AcademicsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed text-lg">
                <p>At Grace Mission Primary School, we fiercely commit to academic excellence. Our teaching framework is robustly aligned with the updated Zimbabwe School Examinations Council (ZIMSEC) syllabus, ensuring our students are nationally competitive.</p>
                <p>We merge this national standard with 21st-century pedagogical methods — integrating technology, continuous assessment, and hands-on learning — so our learners memorize less and understand more.</p>
              </div>
            </div>
      ...
      {/* Grade Levels Tabs */}
      <motion.section {...sectionAnim} className="py-20 md:py-28 bg-[#EBF2FA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
            {/* Tab Buttons */}
            <div className="flex flex-row lg:flex-col overflow-x-auto lg:overflow-visible gap-2 lg:gap-4 pb-4 lg:pb-0 lg:w-1/3">
              {GRADE_LEVELS.map((level) => (
                <button
                  key={level.id}
                  onClick={() => setActiveTab(level.id)}
                  className={`relative text-left px-6 py-4 rounded-2xl font-medium transition-all duration-300 w-full whitespace-nowrap lg:whitespace-normal ${
                    activeTab === level.id
            ...
            <div className="lg:w-2/3 bg-white rounded-[2rem] p-8 md:p-12 shadow-xl border border-gray-100 min-h-[400px]">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed mb-8">{activeLevel.description}</p>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mt-auto pt-8 border-t border-gray-100">
                    ...
                    <div className="bg-[#F7F8FA] rounded-2xl p-5 border border-gray-100">
                      ...
                      <p className="text-sm leading-relaxed text-gray-600 font-medium">{activeLevel.achievements}</p>
                    </div>
                  </div>
                </motion.div>
              </AnimatePresence>
      ...
      <motion.section {...sectionAnim} className="py-20 md:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 mt-4 max-w-2xl mx-auto">Education goes beyond the classroom. We offer a vibrant array of clubs and sports to develop well-rounded individuals.</p>
          </div>
      ...
      <section className="bg-[#1A3A6B] py-24 relative overflow-hidden text-center">
        <div className="max-w-4xl mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            <h2 className="font-serif text-4xl md:text-5xl font-bold text-white mb-8">Ready to join Grace Mission?</h2>
            <Link href="/admissions" className="inline-flex items-center justify-center gap-2 px-10 py-4 bg-[#E8729A] text-white rounded-full font-bold text-lg transition-transform hover:scale-105 shadow-xl">
              Enroll Now
