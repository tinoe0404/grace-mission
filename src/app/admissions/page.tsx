    ...
    <div className="flex flex-col min-h-screen bg-surface overflow-hidden">
      ...
      <section className="bg-primary pt-32 pb-16 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <h1 className="font-serif text-5xl md:text-6xl text-white font-bold mb-4 tracking-tight">Admissions</h1>
            <div className="flex items-center gap-2 text-sm text-white/80">
              <Link href="/" className="hover:text-white transition-colors">Home</Link>
              <ChevronRight className="w-4 h-4" />
              <span className="text-secondary font-medium">Admissions</span>
            </div>
          </motion.div>
        </div>
      </section>
