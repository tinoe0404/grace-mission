...
export default function AboutPage() {
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed text-[15px]">
                <p className="max-w-none">Founded in 2005, Grace Mission Primary School began with a simple but profound vision: to provide a nurturing, high-quality education rooted in Christian values. Located in the heart of Harare, we started with just two classrooms and a handful of dedicated staff members.</p>
                <p className="max-w-none">Over the past two decades, our community has flourished. We have grown to serve over 500 pupils from ECD up to Grade 7, continuously expanding our facilities and curriculum to meet the demands of a modern, rapidly changing world.</p>
                <p className="max-w-none">At our core, we remain a closely-knit family. We treat every child as an individual gift from God, focusing not just on academic excellence, but on shaping character, fostering compassion, and preparing them for a life of purpose.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* 3. Head Teacher Quote - bg-[#EBF2FA] editorial style */}
      <section className="py-24 md:py-32 bg-[#EBF2FA]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <span className="text-[#E8729A] text-[100px] md:text-[120px] leading-none font-serif select-none pointer-events-none -mb-6">
              &ldquo;
            </span>
            ...
            <p className="text-gray-500 text-sm font-medium">Headmistress</p>
          </motion.div>
        </div>
      </section>

      {/* 4. Mission / Vision / Values - bg-[#F7F8FA] card grid */}
            ...
            {TEAM.map((staff, i) => (
              ...
              >
                <motion.div 
                  whileHover={{ y: -6 }}
                  transition={{ duration: 0.2 }}
                  className="relative w-48 h-48 rounded-full mb-6 overflow-hidden ring-4 ring-gray-50 group-hover:ring-[#E8729A]/20 transition-all duration-300"
                >
                  <Image src={staff.image} alt={staff.name} fill className="object-cover" />
                  {/* Hover overlay - subtle pink tint */}
                  <div className="absolute inset-0 bg-[#E8729A]/0 group-hover:bg-[#E8729A]/20 transition-all duration-300 z-10" />
                </motion.div>
