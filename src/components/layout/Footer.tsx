        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              <a href="#" className="text-white/40 hover:text-white transition-colors" aria-label="X (Twitter)">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
              </a>
              <a href={`https://wa.me/${SCHOOL_DETAILS.whatsapp.replace(/[^0-9]/g, "")}`} target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors" aria-label="WhatsApp">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-start gap-3">
                ...
                <span className="font-sans text-sm text-white/70">123 Grace Mission Road, Marlborough, Harare, Zimbabwe</span>
              </div>
              <div className="flex items-start gap-3">
            ...
            <Link href="/contact" className="mt-4 inline-flex items-center border border-white/20 text-white/70 hover:bg-white/10 text-sm px-4 py-2 rounded-full font-sans transition-colors">
              Send a Message
            </Link>
          </div>
        </div>
